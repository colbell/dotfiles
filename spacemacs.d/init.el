...
layers configuration. You are free to put any user code."
  ...
  ;; When marks are deleted (:delm!), evil-visual-mark-mode doesn't clear them
  ;; unless toggled (disabled/enabled).
